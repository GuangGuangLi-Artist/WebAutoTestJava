...
public   class Day19BaseServlet extends HttpServlet {


    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        //1：获取参数，用来识别用户想请求的方法
        //2:然后判断使用哪一个方法，是哪一个就调用哪一个
        ...
        /**
         * 得到方法名，是否可通过反射来调用方法
         * 1.得到方法名，通过方法名再得到Mthod类的对象
         * 需要得到clss,然后调用它的方法进行查询，得到Mrthod
         * 我们要查询的是当前类的方法，所以我们需要得到当前类的class
         */
        Class c = this.getClass();//得到当前类的clss对象
        Method method = null;
        ...
        try {
            ...
            //获取请求处理方法执行后返回的字符串，它表示转发或重定向的路径，帮它完成转发或者重定向
            ...
            if (result.contains(":")){
                ...
                if(s.equalsIgnoreCase("r")){//如果是前缀r,那么重定向
